  ...
  <style>
    ...
    <body>
        ...
        <table border="3">
            ...
            <tr bgcolor="#669900" font-color="white">
                ...
                <%
                    try{
                                        ...
                                        //String date=request.getParameter("date");
                                              String qu="select * from attendances where name='"+name+"' AND courseName='"+courseName+"' AND semester='"+semester+"' AND date='"+date+"'";
         ...
         <button><a href="SW_viewattendance.jsp">Back</a></button>
        </form>

			       ...
			       <table border="3">
					...
					<c:forEach items="${faculties}" var="fa" >
                                                   ...
                                                   <tr>
                                                        ...
                                                        <td align="center"><c:out value="${fa.index}" /></td>
							<td align="center"><c:out value="${fa.firstName}" /></td>
                                                         <td align="center"><c:out value="${fa.lastName}" /></td>
							<td align="center"><c:out value="${fa.email}" /></td>
							<td align="center"><c:out value="${fa.password}" /></td>
                                                        <td align="center"><c:out value="${fa.dob}" /></td>
                                                         <td align="center"><c:out value="${fa.gender}" /></td>
							<td align="center"><c:out value="${fa.mobileNo}" /></td>

                                                        <td align="center"><a href="FacultyCtl?action=edit&id=<c:out value="${fa.firstName}" />">Edit</a></td>
                                                        
							<td align="center"><a href="FacultyCtl?action=delete&id=<c:out value="${fa.firstName}" />">Delete</a></td>
						</tr>
					...
					<!-- } -->
                                ...
                                <button><a href="FacultyCtl?action=insert">New</a></button>
		</div>
	</div>

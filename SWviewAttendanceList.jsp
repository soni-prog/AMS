 ...
 <jsp:declaration>
        ...
        <table border="3">
            ...
            <tr bgcolor="#669900" font-color="white">
                ...
                <td align="center" width="5%"><b>Mark Attendance</b></td>
            </tr>
                <%
                    try{
                                        ...
                                        //String date=request.getParameter("date");
                                              String qu="select * from attendances where name='"+name+"' AND courseName='"+courseName+"' AND semester='"+semester+"'";
                                              ...
                                              while(rs.next())
                                              {
                                                  %>
                                                       <tr>
                                                           <td align="center" name="studentId" id="studentId"><%=rs.getString("studentId")%></td>
                                                           
                                                           <td align="center" name="name" id="name"><%=rs.getString("name")%></td>
                                                           <td align="center" name="courseName" id="courseName"><%=rs.getString("courseName")%></td> 
                                                           <td align="center" name="subjectName" id="subjectName"><%=rs.getString("subjectName")%></td>
                                                            <td align="center"  name="semester" id="semester"><%=rs.getString("semester")%></td>
                                                          <td align="center" name="date" id="date"><%=rs.getString("date")%></td>
                                                            <td align="center"  name="attendanceStatus" id="attendanceStatus"><%=rs.getString("attendanceStatus")%></td>
